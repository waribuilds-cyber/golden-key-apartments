    ...
    <section id="reviews" className="scroll-mt-20 bg-secondary/50 py-20 sm:py-28">
      <div className="mx-auto max-w-6xl px-5">
        <SectionHeading
          ...
          subtitle="Real words from travellers who made our apartments their home."
        />

        <div className="mt-14 grid gap-6 sm:grid-cols-2">
          {reviews.map((r) => (
            <figure key={r.id} className="relative rounded-2xl border border-border bg-card p-7 shadow-sm">
